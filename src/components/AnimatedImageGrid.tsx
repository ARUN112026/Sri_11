...
const AnimatedImageGrid: React.FC = () => {
  ...
  const images = [
    {
      src: "https://res.cloudinary.com/dpw1lerip/image/upload/v1775832248/WhatsApp_Image_2026-04-10_at_7.26.51_PM_1_exjxwe.jpg",
      caption: "You Made My Dreams Come True",
      delay: 0
    },
    {
      src: "https://res.cloudinary.com/dpw1lerip/image/upload/v1775832246/WhatsApp_Image_2026-04-10_at_7.26.39_PM_azki8c.jpg",
      caption: "Every Moment With You",
      delay: 0.2
    },
    {
      src: "https://res.cloudinary.com/dpw1lerip/image/upload/v1775832251/WhatsApp_Image_2026-04-10_at_7.26.55_PM_m2ojax.jpg",
    ...
    {
      src: "https://res.cloudinary.com/dpw1lerip/image/upload/v1775832251/WhatsApp_Image_2026-04-10_at_7.26.54_PM_1_pconwf.jpg",
      caption: "Love Beyond Words",
      delay: 0.8
    },
    {
      src: "https://res.cloudinary.com/dpw1lerip/image/upload/v1775832250/WhatsApp_Image_2026-04-10_at_7.26.53_PM_1_jy3olu.jpg",
